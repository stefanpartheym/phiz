...
pub fn World(BodyUserData: type) type {
    return struct {
        ...
        fn detectCollisions(self: *Self) !void {
            const zone = ztracy.ZoneN(@src(), "detectCollisions");
            defer zone.End();
        ...
        fn detectCollisionsBroadPhase(self: *Self) ![]const SpatialHashGrid.BodyPair {
            const zone = ztracy.ZoneN(@src(), "detectCollisionsBroadPhase");
            defer zone.End();
        ...
        fn detectCollisionsNarrowPhase(self: *Self, pairs: []const SpatialHashGrid.BodyPair) !void {
            const zone = ztracy.ZoneN(@src(), "detectCollisionsNarrowPhase");
            defer zone.End();
        ...
        fn resolveCollisions(self: *Self) !void {
            const zone = ztracy.ZoneN(@src(), "resolveCollisions");
            defer zone.End();
        ...
        fn resolveDynamicStaticCollision(self: *Self, collision: Collision) !void {
            const zone = ztracy.ZoneN(@src(), "resolveDynamicStaticCollision");
            defer zone.End();
        ...
        fn resolveDynamicDynamicCollision(self: *Self, collision: Collision) !void {
            const zone = ztracy.ZoneN(@src(), "resolveDynamicDynamicCollision");
            defer zone.End();
